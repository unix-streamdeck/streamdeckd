...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/boxes-ltd/imaging)](https://pkg.go.dev/github.com/boxes-ltd/imaging)
[![Build Status](https://github.com/boxes-ltd/imaging/actions/workflows/go.yml/badge.svg)](https://github.com/boxes-ltd/imaging/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/boxes-ltd/imaging)](https://goreportcard.com/report/github.com/boxes-ltd/imaging)
...
_This is a fork of the original project with dependency updates and CVE-2023-36308 fixed._
...
https://pkg.go.dev/github.com/boxes-ltd/imaging
...
[imaging](https://github.com/boxes-ltd/imaging)
is designed to be a lightweight and simple image manipulation package.
It provides basic image processing functions and a few helper functions
such as `Open` and `Save`. It consistently returns *image.NRGBA image 
type (8 bits per channel, RGBA).

[gift](https://github.com/boxes-ltd/gift)
